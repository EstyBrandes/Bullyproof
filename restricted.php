<?php
    ...
    $sql = "SELECT patient_id FROM tbl_207_patient WHERE parent_id = ?";
	...
	$pageTitle = "403 restricted";
    $breadcrumbs = '<ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="patientcontent.php?patient_id=' . $patient_id . '">Patient</a></li>
                            <li class="breadcrumb-item"><a href=#> restricted </a></li>
                        </ol>';
